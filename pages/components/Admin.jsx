...
const Getter = () => {
    ...
    return (
        <div className='getter-container md: mr-[300px] md:ml-[250px] xl:flex xl:flex-row'>
            <div className='getter-card md:m-5'>
                ...
                <div className='md:flex items-center'>
                    ...
                    <input type="number" className='p-1 m-1 md:w-[500px] w-[200px] bg-[#595859]   hover:bg-yellow-50 rounded-xl border border-b-gray-800' placeholder='Enter Id Here'
                        onChange={(e) => { setId(e.target.value) }} />
                </div>
                <div className='md:flex items-center'>
                    <p className='text-2xl font-semibold'>Your Remark: </p>
                    <input type="text" className='p-1 m-1 md:w-[500px] w-[200px] bg-[#595859]   hover:bg-yellow-50 rounded-xl border border-b-gray-800' placeholder='Enter Remark Here'
                        onChange={(e) => { setARemark(e.target.value) }} />
                </div>
                <div className='flex'>
                    <button className="button-common  hover:bg-green-500" onClick={handleApproveComplaint}>Approve Complaint</button>
                    <button className="button-common hover:bg-red-500" onClick={handleDeclineComplaint}>Decline Complaint</button>
                </div>
            ...
            <div className='getter-card md:m-5'>
                ...
                <div className='flex items-center mt-3'>
                    <button className="button-common hover:bg-blue-900 rounded-xl border" onClick={getPendingResolutions}>Next Pending Resolution ID</button>
                    {
                        pendingResolutions && (
                ...
                <div className='md:flex items-center'>
                    <p className='text-2xl font-semibold'>Complaint Id: </p>
                    <input type="number" className='getter-input md:w-[500px] bg-[#595859]  hover:bg-yellow-50 rounded-xl border border-b-gray-800' placeholder='Enter Id Here'
                        onChange={(e) => { setRId(e.target.value) }} />
                </div>
                <div className='md:flex items-center'>
                    <p className='text-2xl font-semibold'>Your Remark: </p>
                    <input type="text" className='getter-input md:w-[500px] bg-[#595859]  hover:bg-yellow-50 rounded-xl border border-b-gray-800' placeholder='Enter Remark Here'
                        onChange={(e) => { setRRemark(e.target.value) }} />
                </div>
                <button className="button-common hover:bg-green-500 rounded-xl border " onClick={handleResolveComplaint}>Resolve Complaint</button>
            </div>
