...
const Status = () => {
    ...
    return (
        <div className='status-container '>
            <div className='status bg-[#f9cada]'>
                <p className='status-title'>Check Status of Your Complaint:</p>
                <div className='flex items-center justify-center'>
                    <p className='status-text'>Complaint ID:</p>
                    <input type="number" className='status-input md:w-[300px] bg-[#595859]  hover:bg-yellow-50 rounded-xl border border-b-gray-800' placeholder='Enter Complaint ID'
